...
import { checkAuth, login, logout, signup, updateProfile, deleteAccount, restoreAccount, updatePrivacySettings, updateNotificationSettings } from "../controllers/auth.controller.js";
import {
  createQRSession,
  linkDevice,
  qrLogin,
